...
public interface StatObject<T extends Number>
{
	...
	/**
	 * Returns the result of this statistical function in an ArrayList. Null values in the data set are ignored for purposes of calculation.
	 ...
	 * @throws RuntimeException Thrown if the data in this StatObject is null or empty. Note that null values are not the same as the entire data set being null.
	 */
