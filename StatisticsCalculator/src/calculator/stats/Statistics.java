...
public interface Statistics<T extends Number>
{
	 ...
	 * @return Returns true if the file is successfully read and false otherwise.y
	 */
	 ...
	 */
	public enum DATA
	{USAF, WBAN, YR_MO_DA_HR_MN /* Year, Month, Day, Hour, Minute */, DIR, SPD, GUS, CLG, SKC, L, M, H, VSB, MW_1, MW_2, MW_3, MW_4, AW_1, AW_2, AW_3, AW_4, W, TEMP, DEWP, SLP, MAX, MIN, PCP01, PCP06, PCP24, PCPXX, SD}
}